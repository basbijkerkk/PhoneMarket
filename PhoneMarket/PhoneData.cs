...
namespace PhoneMarket
{
    public class PhoneData
    {
        ...
        {
            Phones.Add(new PhoneInfo("Huawei", "P30", "6.47\" FHD + (2340x1080) OLED, Kirin 980 Octa - Core(2x Cortex - A76 2.6GHz + 2x Cortex - A76 1.92GHz + 4x Cortex - A55 1.8GHz), 8GB RAM, 128GB ROM, 40 + 20 + 8 + TOF / 32MP,\n Dual SIM,\n 4200mAh,\n Android 9.0 + EMUI 9.1", 697));
            Phones.Add(new PhoneInfo("Samsung", "Galaxy A52", "64 megapixel camera, 4k videokwaliteit6.5 inch AMOLED scherm128 GB opslaggeheugen (Uitbreidbaar met Micro-sd)Water-en stofbestendig (IP67)", 399));
